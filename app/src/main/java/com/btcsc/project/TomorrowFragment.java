 ...
 */
public class TomorrowFragment extends Fragment implements PlanningAdapterTomorrow.setOnclick {
    ...
    PlanningAdapterTomorrow planningAdapterTomorrow;
    ArrayList<Planning> dataTomorrow;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView= view.findViewById(R.id.rvFramentTomorrow);
        imageAdd=view.findViewById(R.id.imageAddMain5Tomorrow);
        ...
        searchView =view.findViewById(R.id.searchViewTomorrow);
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String newText) {
                planningAdapterTomorrow.getFilter().filter(newText);
        ...
        planningAdapterTomorrow = new PlanningAdapterTomorrow(getActivity(),dataTomorrow,this);
        recyclerView.setLayoutManager(new LinearLayoutManager(getContext(),LinearLayoutManager.VERTICAL,false));
        recyclerView.setAdapter(planningAdapterTomorrow);
    ...
    public void onDeleteTomorrow(Planning planning) {
        ...
        builder.setPositiveButton("YES", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                planningAdapterTomorrow.notifyDataSetChanged();
