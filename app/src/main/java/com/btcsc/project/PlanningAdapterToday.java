...
public class PlanningAdapterToday extends RecyclerView.Adapter<PlanningAdapterToday.PlanningVH> implements Filterable {
    Context context;
    ArrayList<Planning> data;
    setOnclick longListener;
    ArrayList<Planning> listFliter;

    public PlanningAdapterToday(Context context, ArrayList<Planning> data, setOnclick longListener) {
    ...
    interface setOnclick{
        void onLongClickToday(Planning planning);
        void onDeleteToday(Planning planning);
    }
    @NonNull
    @Override
    ...
    public void onBindViewHolder(@NonNull PlanningVH holder,final int position) {
        ...
        holder.itemView.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                longListener.onLongClickToday(plan);
                return false;
            }
        });
        holder.checkBox.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    longListener.onDeleteToday(plan);
