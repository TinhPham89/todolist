...
public class ShowListAdapter extends RecyclerView.Adapter<ShowListAdapter.PlanningVH> implements Filterable {
    Context context;
    ArrayList<Planning> data;
    setOnclick longListener;
    ArrayList<Planning> listFliter;

    public ShowListAdapter(Context context, ArrayList<Planning> data, setOnclick longListener) {
