 ...
 */
public class TodayFragment extends Fragment implements PlanningAdapterToday.setOnclick {
    ...
    ArrayList<Planning>  dataToday;
    SearchView searchView;
    ImageView imageAdd;
    PlanningAdapterToday planningAdapterToday;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView = view.findViewById(R.id.rvFramentToday);
        imageAdd=view.findViewById(R.id.imageAddMain5Today);
        ...
        searchView=view.findViewById(R.id.searchViewToday);
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String newText) {
                planningAdapterToday.getFilter().filter(newText);
        ...
        planningAdapterToday = new PlanningAdapterToday((MainActivity5)getActivity(),dataToday, this);
        recyclerView.setLayoutManager(new LinearLayoutManager(getContext(),LinearLayoutManager.VERTICAL,false));
        recyclerView.setAdapter(planningAdapterToday);
    ...
    public void onDeleteToday(Planning planning) {
        ...
        builder.setPositiveButton("YES", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                planningAdapterToday.notifyDataSetChanged();
